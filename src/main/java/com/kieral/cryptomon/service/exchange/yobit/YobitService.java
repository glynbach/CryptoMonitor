...
import com.kieral.cryptomon.service.exchange.yobit.payload.YobitAccountsResponse;
import com.kieral.cryptomon.service.exchange.yobit.payload.YobitOrderBookResponse;
...
public class YobitService extends BaseExchangeService {

	public YobitService(YobitServiceConfig serviceProperties, ServiceSecurityModule securityModule) {
	...
	protected void subscribeMarketDataTopics() {
		throw new IllegalStateException("Yobit has no streaming topics");
	}
	...
	protected Class<? extends OrderBookResponse> getOrderBookResponseClazz() {
		return YobitOrderBookResponse.class;
	}

	@Override
	protected Class<? extends AccountsResponse> getAccountsResponseClazz() {
		return YobitAccountsResponse.class;
	}
