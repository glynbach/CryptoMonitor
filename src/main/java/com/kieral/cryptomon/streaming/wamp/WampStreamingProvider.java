...
//TODO: Need to reimplement without jawampa, the mina dependency it uses does not sit well with spring boot rest template 
...
//					.map(pubSubData -> {
//						return new WampStreamingPayload(pubSubData, currencyPair, System.currentTimeMillis());
//					});
//		} else {
